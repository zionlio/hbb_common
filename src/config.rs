...
pub const LINK_DOCS_HOME: &str = "https://www.baidu.com/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://www.baidu.com/";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str = "https://www.baidu.com/";
lazy_static::lazy_static! {
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["117.132.9.228"];
pub const RS_PUB_KEY: &str = "jYyxkC7dos17BaSkOxXElyAtB9ZY9QcbNXK0l1FxuzU=";
