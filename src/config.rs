...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Ferroli".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["http://183.236.245.250"];
pub const RS_PUB_KEY: &str = "2JljKWZcu9sDPZnm3cyOk4etIweMira8VbJGKgprTj0";
