...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = { let mut map = HashMap::new(); map.insert("password".to_string(), "@Fy9!n0KwI%%$P=Jd(Uo".to_string()); RwLock::new(map) };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.153.199.150"];
pub const RS_PUB_KEY: &str = "MhTbP8FXZTBzoxW5WoptdokxN37dcE9t08354eYPusA=";
