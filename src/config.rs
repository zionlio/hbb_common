...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "686758619".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ru.4136.cn"];
pub const RS_PUB_KEY: &str = "HFwdtaAgpcSGE89V5eGWmwUA38b+gh6PRiDzwQWsxms=";
